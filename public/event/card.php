...
$events = new Event();
$uuid = $_GET['uuid'];
if ($uuid == '') die('No Event');
$event = $events->getByUUID($uuid);
?>
...
<?php 
if (!$event) 
  die('<div class="d-flex justify-content-center"><p class="text-white">No Event / Event Expired</p></div>');
  Event::updateView($event->uuid)
?>
